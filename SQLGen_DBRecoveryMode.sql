...
DESCRIPTION:
--------------------------------------------------------------------------------
Generate a script used to perform a database OPTION command change to SIMPLE or FULL recovery
...
SELECT 'ALTER DATABASE ['+[name]+'] SET RECOVERY SIMPLE -- FULL'+CHAR(13)+CHAR(10)+'GO'+CHAR(13)+CHAR(10)
