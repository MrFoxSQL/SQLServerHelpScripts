...
DESCRIPTION:
--------------------------------------------------------------------------------
Generate a script used to perform a database DETACH command for all databases
...
SELECT 'execute dbo.sp_detach_db @DBName = ['+[name]+'], @skipchecks = ''true'', @KeepFulltextIndexFile = ''true'''+CHAR(13)+CHAR(10)+' GO'+CHAR(13)+CHAR(10)
