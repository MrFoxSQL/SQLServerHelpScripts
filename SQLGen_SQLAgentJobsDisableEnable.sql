...
DESCRIPTION:
--------------------------------------------------------------------------------
Generate a script used to enable or disable the SQL Agent jobs
...
SELECT 'execute msdb.dbo.sp_update_job @job_name = '''+[name]+''', @enabled = 0 -- DISABLED'+CHAR(13)+CHAR(10)+'GO'+CHAR(13)+CHAR(10)
